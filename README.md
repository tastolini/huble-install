...
the Atlas plugin preconfigured for your role (CX / Copy / SEO / Design / Dev — each machine gets only its stage's tooling and a sparse checkout of just its slice of the vault).
